(() => {
  ...
  const CSS_STYLES = `
    ...
    #${PANEL_ID} {
      --jwp-panel-top: rgb(13, 13, 14);
      --jwp-panel-bottom: rgb(0, 0, 0);
      --jwp-glow: rgba(255, 255, 255, .035);
      --jwp-panel-background: rgb(0, 0, 0);
      ...
      filter: brightness(var(--jwp-panel-brightness, .8));
    ...
    #${PANEL_ID}[data-theme="frost"] {
      ...
      --jwp-panel-top: rgb(30, 40, 54);
      --jwp-panel-bottom: rgb(13, 20, 30);
    ...
    #${PANEL_ID}[data-theme="violet"] {
      --jwp-panel-background:
        radial-gradient(circle at 90% 0%, var(--jwp-glow), transparent 38%),
        linear-gradient(180deg, var(--jwp-panel-top), var(--jwp-panel-bottom));
      --jwp-panel-top: rgb(30, 24, 43);
      --jwp-panel-bottom: rgb(11, 7, 18);
    ...
    #${PANEL_ID}[data-theme="ember"] {
      --jwp-panel-background:
        radial-gradient(circle at 90% 0%, var(--jwp-glow), transparent 38%),
        linear-gradient(180deg, var(--jwp-panel-top), var(--jwp-panel-bottom));
      --jwp-panel-top: rgb(43, 28, 22);
      --jwp-panel-bottom: rgb(18, 9, 6);
    ...
    .jwp-brightness-label { display: flex; justify-content: space-between; gap: .5rem; }
    #jwp-panel-brightness {
      display: block;
      width: 100%;
      margin: 0 0 1rem;
